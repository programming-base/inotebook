        ...
        <nav className="max-w-full mx-auto px-4 sm:px-6 lg:px-5">
          <div className="flex items-center justify-between h-16 ">
            ...
            <div  className="flex items-center space-x-2 mr-6 ">
              <div id="logo-icon" className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-green-500 text-transparent bg-position-[-1rem] bg-clip-text  w-[20vw] ">
                iNotebook
              </div>
            ...
            >
              ...
              <Link to="/signup">
                <button
                  type="button"
                  className="px-4 py-2 rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition shadow "
                >
                  Sign Up
                </button>
              </Link>
